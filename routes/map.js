...
var mapFilterParameters = [
  ...
  },
  {
    name: "Population",
    id: "population",
    options: ['<20,000', '20,000–50,000', '50,000–100,000', '100,000–200,000', '200,000–500,000', '500,000–100,0000', '100,0000–200,0000', '200,0000–500,0000', '>500,0000'],
    type: "range", num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
  },
  {
    name: "Activity",
    id: "activity",
